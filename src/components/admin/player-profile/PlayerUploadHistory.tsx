...
import { RefreshCw, Video, Clock, CheckCircle, XCircle, Loader2, ChevronRight } from "lucide-react";
      ...
      <CardContent>
        {isLoading ? (
          ...
          <div className="space-y-2">
            <div className="grid grid-cols-7 gap-2 text-xs font-medium text-slate-400 px-3 py-2 border-b border-slate-700">
              <span>Date</span>
            ...
            {uploads.map((upload) => (
              <div 
                key={upload.id} 
                className="grid grid-cols-7 gap-2 items-center px-3 py-2 rounded-lg hover:bg-slate-800/50 text-sm cursor-pointer transition-colors"
