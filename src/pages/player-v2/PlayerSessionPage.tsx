...
import { Dumbbell, Play, Check, X, Upload, RotateCcw } from "lucide-react";
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {isSynapse && <span className="text-[10px] font-bold px-1.5 py-0.5 rounded" style={{ background: 'rgba(230,57,70,0.2)', color: '#E63946' }}>KEY DRILL</span>}
                        {isTowel && <span className="text-[10px] font-bold px-1.5 py-0.5 rounded" style={{ background: 'rgba(78,205,196,0.2)', color: '#4ecdc4' }}>DIAGNOSTIC</span>}
                      </div>
                      ...
                      {d.drill?.cues && d.drill.cues.length > 0 && (
                        <div className="mt-2 rounded-lg p-2.5" style={{ background: '#0a0a0a' }}>
                          <p className="text-[12px] leading-relaxed" style={{ color: '#777' }}>{d.drill.cues[0]}</p>
                        </div>
                      )}
                      ...
                      {!isComplete && (
                        <div className="flex gap-2 mt-3">
                          <button
                            ...
                            style={{ background: '#1a1a1a', border: '1px solid #333', color: '#a0a0a0' }}
                          >
          ...
          <div className="w-full max-w-2xl px-4">
            {videoModal.url ? (
              ...
              <div className="text-center py-20">
                ...
                <p className="text-sm mt-2" style={{ color: '#777' }}>{videoModal.name}</p>
              </div>
            )}
          </div>
        </div>
